...
class _BookingFormState extends State<BookingForm> {
  ...
  Future<void> _loadBatches() async {
    ...
    setState(() {
      _batches = b.where((x) => x.isActive).toList();
  ...
  Future<void> _submit() async {
    ...
    if (res['success'] == true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(
            res['message']?.toString() ?? 'Failed to save'),
                              ...
                              children: [
                                Text('New Booking',
                                    style: GoogleFonts.poppins(
                                        ...
                                        fontSize: 16)),
                                Text('Fill customer details below',
                                    style: GoogleFonts.poppins(
                                  ...
                                  Padding(
                                    ...
                                    child: TableCalendar(
                                      ...
                                      lastDay: DateTime.utc(
                                          2027, 12, 31),
                                      focusedDay: _visitDate,
                                      selectedDayPredicate: (d) =>
                                          isSameDay(d, _visitDate),
                                      onDaySelected: (s, _) =>
                                          setState(() {
                                        _visitDate = s;
                                        _showCal = false;
