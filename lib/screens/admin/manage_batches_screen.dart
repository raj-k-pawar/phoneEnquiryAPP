...
class _ManageBatchesScreenState extends State<ManageBatchesScreen> {
  ...
  void _showDialog({BatchModel? batch}) {
    ...
    final capCtrl   = TextEditingController(
        text: batch?.capacity.toString() ?? '50');
          ...
          content: Form(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              TextFormField(
                controller: endCtrl,
                decoration: const InputDecoration(
                    labelText: 'End Time (e.g. 2:00 PM)'),
                validator: (v) => v!.isEmpty ? 'Required' : null,
              ),
              const SizedBox(height: 12),
              TextFormField(
              ...
              onPressed: saving
                  ...
                  : () async {
                      ...
                      final data = {
                        ...
                        'capacity':
                            int.tryParse(capCtrl.text) ?? 50,
                      };
                      final res = batch == null
                          ? await ApiService.addBatch(data)
  ...
  Future<void> _delete(BatchModel b) async {
    ...
    if (ok == true) {
      await ApiService.deleteBatch(b.id);
      _load();
    }
  }
        ...
        body: _loading
            ...
            : RefreshIndicator(
                ...
                child: _batches.isEmpty
                    ? Center(
                        child: Text('No batches. Tap + to add.',
                            style: GoogleFonts.poppins(
                              ...
                              title: Text(b.name,
                                  style: GoogleFonts.poppins(
                                      fontWeight:
                                          FontWeight.w600)),
                              subtitle: Text(
                                '${b.startTime} – ${b.endTime} · Cap: ${b.capacity}',
                                style: GoogleFonts.poppins(
                                    fontSize: 12,
                                    color: kTextSecondary),
                              ),
